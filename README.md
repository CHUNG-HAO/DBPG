...
> 4. Dealers 和 DealerBrands：PK為預設ID, 而BRANDid 為 DEALERiD 同為fk , 一個經銷商 (Dealers) 可以銷售多個品牌 (DealerBrands)，所以這是一對多的關係。
...
> 9. Factories 和 FactoryBrands：pk為預設ID, 而bandID 和factoryID 為fk, 所以這是一對多的關係。
> 11. Brands 和 FactoryBrands：一個品牌 (Brands) 可以在多個工廠 (FactoryBrands) 中生產，所以這是一對多的關係。
